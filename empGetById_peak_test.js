...
export const options = {
  stages: [
    { duration: "5m", target: 7000 }, // Ramp-up เพิ่มจาก 0 ถึง 5,000 user ใน 2 นาที
    // { duration: "6m", target: 10000 }, // ยิง 10,000 user คงที่เป็นเวลา 6 นาที
...
const BASE_URL = "http://150.95.80.78:9003/api/employee/getById";
